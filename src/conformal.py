"""
Conformal Prediction Wrapper — MAPIE CrossConformalRegressor with Jackknife+ method.

Provides mathematically guaranteed 90% prediction intervals via cross-conformal inference.
"""
